...
public class Integration
{
    ...
    public static void main(String[] args)
    {
        ...
        // https://github.com/rstjohn/latiz/blob/master/latizrcp/AandRLibrary/src/com/AandR/library/math/Integration.java
        ...
        if (Precision.equals(AUC, 0.8926, 1e-3))
            ...
            throw new AssertionError("Calculated and expected AUC do not match.");
    }
}
